...
class Review(BaseModel): 
    ...
    sentiment : Literal["pos","neg"] = Field("Return sentiment of review either negative,positive or neutral")
    key_themes : list[str] = Field(description="Write down all the key themes discussed in review")
    pros : Optional[list[str]] = Field(description="Write dowm all the pros inside list")
    cons : Optional[list[str]] = Field(description="Write dowm all the cons inside list")
